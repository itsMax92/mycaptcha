...
@WebServlet(description = "Login Servlet", urlPatterns = {"/login"}, initParams = {
		@WebInitParam(name = "user" , value = "Mukul"),
...
public class LoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String recaptchaResponse = request.getParameter("recaptcha-response");
		...
		System.out.println("User= " +user+ "::password= " +password+ ":: Captcha Verify " +verify);
		
		if(userId.equals(user) && password.equals(pass) && verify) {
